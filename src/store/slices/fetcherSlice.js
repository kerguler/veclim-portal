...
const fetcherSlice = createSlice({
	...
	reducers: {
		...
		setBrushDatayL(state, action) {
			const { direction, value } = action.payload;
			state.fetcherStates.menu[direction].chart.brush.brushDatayL = value;
		},
		setBrushDatayR(state, action) {
			const { direction, value } = action.payload;
			state.fetcherStates.menu[direction].chart.brush.brushDatayR = value;
		},
...
export const {setBrushDatayL,setBrushDatayR,
	setShimmered,
