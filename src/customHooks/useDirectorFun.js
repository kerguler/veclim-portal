...
function useDirectorFun(direction) {
	...
	const twinIndex = useSelector(
		(state) => state.graphSwitch.left.twinIndex,
	);
	...
	const { tileIcons, parPickerTileIcons } = useContext(PanelContext);
	...
	// TWIN ARRAY
	const twinArrayLeft = useSelector((state) => state.graphSwitch.left.twinArray);
	const twinArrayRight = useSelector(
		(state) => state.graphSwitch.right.twinArrayRight,
	);
	const twinArray = directorFun(direction, twinArrayLeft, twinArrayRight);

	// SWITCHER
	const switcherLeft = useSelector((state) => state.graphSwitch.left.switcher);
	const switcherRight = useSelector(
		(state) => state.graphSwitch.right.switcherRight,
	);
