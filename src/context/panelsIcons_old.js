...
function PanelProvider({ children }) {
      ...
      description: (
        <>
          <p>
            ...
            as predicted by the model (assumes tiger mosquito presence) using low-resolution ECMWF
            seasonal forecasts.
          </p>
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <div className="text-area">
          ...
          <div>
            <p>
              Daily number of eggs laid by the Asian tiger mosquito as a proxy for biting activity.
            </p>
          </div>
        </div>
      ),
  ...
  return <PanelContext.Provider value={sharedValues}>{children}</PanelContext.Provider>;
}
