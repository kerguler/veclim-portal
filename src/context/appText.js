...
function TextProvider({ children, pageOverride }) {
  ...
  //           </ul>
  //           <p>
  //             We present weekly averages smoothed using a two-week sliding
  //             window to highlight typical seasonal trends. For access to raw
  //             data or further inspection, please consult the original data
  //             sources.
  //           </p>
  //         </>
  //       ),
