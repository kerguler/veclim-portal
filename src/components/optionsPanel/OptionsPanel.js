...
function OptionsPanel() {
	...
	const showVectorAbundance = useSelector(
		(state) =>
			state.fetcher.fetcherStates.map.optionsPanel.showVectorAbundance,
	);
	...
	const opactive =
		tileOpacity < 1
			? "panel-content icons-area  active"
			: "panel-content icons-area  inactive";
	const labactive = showMapLabels
		? "panel-content icons-area  active"
		: "panel-content icons-area  inactive";
			...
			<div className='text-area'>
				...
				<div className='map-descriptions-wrapper'>
					<div className='description-row'>
						<div className={opactive} onClick={handleChangeOpacity}>
							<img alt='opacity-icon' src={transIcon}></img>
						</div>
						<div>
							<p>Transparent tiles</p>
						</div>
					</div>
					<div className='description-row'>
						<div className={labactive} onClick={handleShowLabels}>
							<img
