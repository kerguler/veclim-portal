		...
		<ReactCardFlip isFlipped={isFlipped} flipDirection="vertical">
			...
			<div className="risk-indicator-container-wrap">
				...
				<div className="risk-indicator-ipanel">
					...
					<ul>
						<li>
							<strong>Larva:</strong> Larvae in a typical breeding site
						</li>
						<li>
							<strong>Biting:</strong> Mosquito activity (bites on people)
						</li>
						<li>
							<strong>Outbreak:</strong> Outbreak risk due to an imported case
						</li>
						<li>
							<strong>Impact:</strong> Average impact of an imported case
						</li>
					</ul>
					<div className="risk-indicator-mini">
						<RiskIndicator props={{ name: "Low", value: 0, text: "" }} />
						<RiskIndicator props={{ name: "Medium", value: 1, text: "" }} />
						<RiskIndicator props={{ name: "High", value: 2, text: "" }} />
					</div>
					<p>
					...
					<p>
						We present <strong>10-year averages</strong> (from 2010 to 2020).
					</p>
					<p>
					...
					<p>Please refer to our methods section for more information.</p>
				</div>
			</div>
		</ReactCardFlip>
	);
