...
function FloatPanelMosquitoInfo() {
	...
	if (isFetching) {
		...
		if (!('location' in data) || !data.location.island) {
			content = (
				<p>
					Ops! We do not have information about the tiger mosquito in
					your region
				</p>
			);
			explain = (
			...
			content = (
				<p>
					There are reports of the <strong>tiger mosquito</strong> in
					your region
				</p>
			);
			explain = (
				<>
					<div className='mosquito-text-full'>
						...
						<p>
							Please check it out,{' '}
							<strong>
								contact your regional authorities for
								information
							</strong>
			...
			content = (
				<p>
					There are <strong>no</strong> reports of the tiger mosquito
					in your region
				</p>
			);
			explain = (
				<>
					<div className='mosquito-text-full'>
						<p>
							<strong>Good news!</strong> The little red square on
							the map does not overlap with any administrative
							region where the tiger mosquito is seen.
						</p>
						<p>
							We try to keep an up-to-date database of mosquito
							sightings. Please let us know if we missed
							something!
						</p>
					</div>
				</>
